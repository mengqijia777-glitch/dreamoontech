...
$(function () {
    ...
    $(function () {
        ...
        // Create ScrollTrigger to continuously monitor scroll and update progress bar
        ScrollTrigger.create({
            trigger: "body",
            start: "top top",
            end: "bottom bottom",
            onUpdate: function(self) {
                // This fires on every scroll movement (including ScrollSmoother)
                let scroll;
                if (window.dreamoonSmoother) {
                    scroll = window.dreamoonSmoother.scrollTop();
                } else {
                    scroll = self.scroll();
                }
        ...
        // Handle anchor navigation - use ScrollSmoother's scrollTo
...
$(document).ready(function () {
    ...
    function updateProgressBar() {
        ...
        var scroll;
        if (window.dreamoonSmoother && typeof window.dreamoonSmoother.scrollTop === 'function') {
            scroll = window.dreamoonSmoother.scrollTop();
        } else {
    ...
    // Listen for scroll events (native scroll)
    $(window).on('scroll', updateProgressBar);

    jQuery('.progress-wrap').on('click', function (event) {
        event.preventDefault();
        if (window.dreamoonSmoother) {
            window.dreamoonSmoother.scrollTo(0, true);
        } else {
